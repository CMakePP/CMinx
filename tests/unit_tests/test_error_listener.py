...
class TestErrorListener(unittest.TestCase):
    ...
    def test_ambiguity(self):
        # This method will only be called if the grammar is bad, call manually
        # to ensure that if it is ever called we get an error
        self.assertRaises(
            RuntimeError,
            self.listener.reportAmbiguity,
            None,
            None,
            None,
            None,
    ...
    def test_full_context(self):
        ...
        # Not an error, only a notification of a differing method than normal
        # resolution
        self.assertEqual(
            None, self.listener.reportAttemptingFullContext(
    ...
    def test_context_sensitivity(self):
        ...
        # No-op
        self.assertEqual(
            None, self.listener.reportContextSensitivity(
                None, None, None, None, None, None))
